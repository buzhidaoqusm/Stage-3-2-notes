...
1. Project Management Plan
	1. approved subsidiary plans 
2. Project Charter 
	1. provide the project context, high-level projectdescription and product characteristics. 
...
4. Group Creativity Techniques
	1. Brainstorming, nominal grouptechnique,idea/mind mapping, affinity diagram
5. Group Decision-MakingTechniques
	1. Unanimity, majority, plurality, dictatorship
6. Questionnaires and Surveys
### Interviews
An interview is a **formal or informal** approach to elicit information from **stakeholders** by **talking to them directly**

may involve multiple interviewers or multiple interviewees
useful for obtaining confidential information
### Focus Group（焦点小组）
Bring together prequalified **stakeholders** and **subject matter experts** to learn about their **expectations** and **attitudes** about aproposed product, service, or result
...
**Joint application design/development** (JAD) sessions are used in the software development industry:
### Brainstorming（头脑风暴）
