...
| Main/Subroutine                         | **Procedures** + visible data                                                                          | **Procedure calls** + data sharing                      | **Single thread of** control; Call and return semantics; Modules **hide** secrets                                                                                                                 | **tight coupling**; not suitable for distributed systems;**weak scalability**                                                                                                                            |
| Object-Oriented                         | **Objects**                                                                                            | **Method calls** (message passing)                      | Encapsulation; Interaction; Polymorphism; Inheritance;**reusability**                                                                                                                             | **God Object**; Excessive **Coupling**; Distributed Difficulty; **Message Passing Overhead**                                                                                                             |
...
| MVC                                     | Model, View, Controller                                                                                | Controller **calls** Model methods; Model notifies View | **Separation of Concerns**; Independent **UI evolution**; **Parallel development**; **Testability**                                                                                               | **Over-design** for small systems; **controller** may become **bloated**                                                                                                                                 |
...
| Repository                              | **Central data structure** + independent components                                                    | **Data access**                                         | **Central** data structure; **Independent** components                                                                                                                                            | Data **format change** affects all modules; **Hard** to enhance or **reuse**; **bottleneck** / SPOF                                                                                                      |
| Blackboard                              | **Blackboard**, Controller, Knowledge Sources                                                          | **Read / Write** shared state                           | Useful when **no algorithm exists**; **Knowledge sources collaborate** through shared state                                                                                                       | The **control logic** is **complex**; **debugging** is **difficult**; **performance** and correctness are hard to guarantee.                                                                             |
