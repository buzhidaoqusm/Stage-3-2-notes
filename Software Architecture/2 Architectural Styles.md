...
| Main/Subroutine                         | Procedures + visible data                                                                      | Procedure calls + data sharing                      | Single thread of control; Call-.3and-return semantics; Modules **hide** secrets                                                                                                                   | Not explicitly stated; large systems require additional structuring                                                                                                                                      |
